function Body( { auto, handleEdit, handleDelete, handleSubmit, marca, modelo, ano, preco, editModels, setMark, setModels, setPrice, setYear } ){
    return(
        <main className="body">
                        ...
                        {auto.map((autos) => (
                            <li key={autos.id} className="auto-car">
                                <div className="auto-details">
                                    ...
                                    <h3>Ano:{autos.ano}</h3>
                                    <p>Preço:R${autos.preco}</p>
                                </div>

                                <div className="auto-actions">
                                    <button onClick={() => handleEdit(autos) }>Editar</button>
                                    <button onClick={() => handleDelete(autos.id)}>Deletar</button>
                                </div>
                            </li>
